...
class ACACCF_OT_export(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        def process_object(props, lod, is_placable, lod_number= None, thumbnail_path=None):
            ...
            # complete xml
            xml = xml_template.get_xml(props.object_name, is_placable, "PROJECT2{2} 3, 90, 288", mesh_script, size_x, size_y, size_z, lod_number, Textures_ids, object_surfaces, object_materials, ac_version, thumbnail_path=thumbnail_path)
