...
if is_lod:
    filepath = f"C:\\Users\\x\\Desktop\\05_Scripts\\{Folder}\\{Sub_folder1}\\{FIle_name}_LOD{Lod}.txt"
    target_filepath = f"C:\\Users\\x\\Desktop\\05_Scripts\\{Folder}\\{Sub_folder1}\\{FIle_name}_LOD{Lod}_opti.txt"
else:
    filepath = f"C:\\Users\\x\\Desktop\\05_Scripts\\{Folder}\\{Sub_folder1}\\{FIle_name}.txt"
    target_filepath = f"C:\\Users\\x\\Desktop\\05_Scripts\\{Folder}\\{Sub_folder1}\\{FIle_name}_opti.txt"
